    ...
    <div class="max-w-md w-full space-y-8">
        <div class="text-center">
            ...
            @if($pengaturan && $pengaturan->logo_persegi)
                <img class="mx-auto h-24 w-auto" src="{{ asset('storage/' . $pengaturan->logo_persegi) }}" alt="{{ $pengaturan->nama_instansi ?? 'Logo' }}">
            @else
                <img class="mx-auto h-24 w-auto" src="{{ asset('images/logo-default.png') }}" alt="Logo">
            @endif
        ...
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Setelah mendaftar, Anda akan mendapatkan bukti pendaftaran dalam bentuk PDF. Silahkan simpan bukti pendaftaran tersebut karena berisi informasi penting untuk login dan proses selanjutnya.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6">
                    <a href="{{ route('auth.register') }}" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-green-600 bg-white hover:bg-gray-50 border-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
